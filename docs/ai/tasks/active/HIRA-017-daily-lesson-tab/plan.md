# Plan: [HIRA-017] Daily Lesson Tab (5 Vocab + 3 Kanji)
...
mode-selection-screen
  ...
  → click Ngày X
  → daily-learn-screen
      Phase 1: Learn vocab (5 items)
      Phase 2: Learn kanji (3 items)
  → daily-practice-screen
      Quick practice cho 8 items vừa học
...
const DAILY_LESSONS = [
  {
    ...
    label: 'Ngày 1',
    vocab: [
      { jp: 'わたし', reading: 'わたし', meaning: 'tôi' },
      ...
    ],
    kanji: [
...
- Mỗi day hiển thị đúng `5 vocab + 3 kanji`
